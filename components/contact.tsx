export default function Contact() {
  return (
    <section id="contact" className="py-24 px-6 bg-gradient-to-b from-slate-950 to-slate-900/50">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12">
          {/* GitHub */}
          <div className="p-6 border border-slate-800 rounded-lg hover:border-cyan-500/50 transition bg-slate-900/30 hover:bg-slate-900/50">
            <div className="w-12 h-12 bg-gradient-to-br from-slate-700 to-slate-800 rounded-lg flex items-center justify-center mb-4">
            ...
            <a href="https://github.com/Senuka9" target="_blank" rel="noopener noreferrer" className="text-cyan-400 font-semibold text-sm hover:text-cyan-300 transition flex items-center gap-1">
              Connect <span>→</span>
            </a>
          </div>
          ...
          <div className="p-6 border border-slate-800 rounded-lg hover:border-cyan-500/50 transition bg-slate-900/30 hover:bg-slate-900/50">
            ...
            <a href="https://www.linkedin.com/in/senuka-kazuhiro-703b0a366/?lipi=urn%3Ali%3Apage%3Ad_flagship3_feed%3BTtpp9GUCRaCdicyD66yIFQ%3D%3D" target="_blank" rel="noopener noreferrer" className="text-cyan-400 font-semibold text-sm hover:text-cyan-300 transition flex items-center gap-1">
              Connect <span>→</span>
            </a>
          </div>
          ...
          <div className="p-6 border border-slate-800 rounded-lg hover:border-cyan-500/50 transition bg-slate-900/30 hover:bg-slate-900/50">
            ...
            <a href="https://mail.google.com/mail/?view=cm&fs=1&to=senuka501@gmail.com" className="text-cyan-400 font-semibold text-sm hover:text-cyan-300 transition flex items-center gap-1">
              Connect <span>→</span>
            </a>
          </div>
        </div>
        ...
        <div className="flex justify-center pt-8">
          <a href="https://mail.google.com/mail/?view=cm&fs=1&to=senuka501@gmail.com" className="px-8 py-3 bg-gradient-to-r from-blue-500 to-cyan-500 text-white rounded-lg font-semibold hover:shadow-lg hover:shadow-blue-500/30 transition duration-300 inline-block">
